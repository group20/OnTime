...
<html>
    ...
    <body>
        <form name="login "id="login" method="post" action="addNewEvent.jsp">
            <h2>New Event</h2>
            ...
            <a href="#" onClick="cal1x.select(document.forms['login'].startdate,'anchor1x','dd/MM/yyyy');return false;" 
            TITLE="cal1x.select(document.forms['login'].startdate,'anchor1x','dd/MM/yyyy'); return false;" NAME="anchor1x" ID="anchor1x">select</a>
            ...
            <a href="#" onClick="cal1x.select(document.forms['login'].enddate,'anchor2x','dd/MM/yyyy');return false;" 
            title="cal2x.select(document.forms['login'].enddate,'anchor2x','dd/MM/yyyy'); return false;" NAME="anchor2x" ID="anchor2x">select</a>
